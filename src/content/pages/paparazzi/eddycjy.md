---
title: "eddycjy.com"
description: "追踪煎鱼的 Go 工程写作、学习路线与开源项目。"
subjectName: "煎鱼"
paparazziTier: "star"
avatarCandidates:
  - url: "https://avatars.githubusercontent.com/u/13746731?v=4"
    source: "GitHub"
    profileUrl: "https://github.com/eddycjy"
---
...
- [go-gin-example](https://github.com/eddycjy/go-gin-example)：Gin 示例项目，是持续可访问的实践入口。
- [Go 学习路线图](https://github.com/eddycjy/go-developer-roadmap)：覆盖 Go 核心知识与面试主题。

## 二、写作与资料源

- [博客 Markdown / 源码](https://github.com/eddycjy/blog)

## 三、追踪结论

博客与仓库均保留公开入口；近期仓库活动更适合用作“最新动态”信号，文章目录则作为后续恢复抓取后的全量归档来源。
