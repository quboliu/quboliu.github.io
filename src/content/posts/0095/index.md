...
**Paxos Made Live: An Engineering Perspective｜让 Paxos 真正运行起来：工程实践视角**
...
**Figure 1: A single Chubby replica.｜图：单个 Chubby 副本。**
...
**Figure 2: API for fault-tolerant log.｜图：容错日志的 API。**
...
### 5.1 Handling disk corruption｜处理磁盘损坏
...
### 5.6 Database transactions｜数据库事务
...
### 6.1 Expressing the algorithm effectively｜有效表达算法
...
### 6.2 Runtime consistency checking｜运行时一致性检查
...
**Table 1: Comparing our system with 3DB (higher numbers are better).｜表：我们的系统与 3DB 的比较（数值越高越好）。**
...
## 9 Summary and open problems｜总结与开放问题
