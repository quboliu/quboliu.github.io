...
title: "论文阅读 | Conflict-free Replicated Data Types（中英对照全文）"
featured: false
...
tags:
  ...
  - "最终一致性"
  - "数据复制"
description: "逐段中英对照精读 CRDT 经典论文，涵盖半格、单调性、交换律、幂等性、基于状态与基于操作的复制模型，以及无需同步协调即可确定性收敛的条件。"
---
> 无冲突复制数据类型
