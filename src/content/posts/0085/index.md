...
> **图 5. 不同云数据库的事务处理性能；con 表示并发数，纵轴表示 TPS。**
...
> **图 6. 采用 TPS、总成本和 E1-Score 对不同云数据库进行弹性评估**
...
> **图 7. CDB4 故障转移过程的时间线；横轴表示不同阶段，纵轴显示 RO 与 RW 的状态。**
...
> **图 8. 将缓冲区大小从 128MB 改为 10GB，对 AWS RDS、CDB1 和 CDB4 进行性能评估。**
...
> **图 9. CloudyBench 与两个现有基准（即 SysBench 和 TPC-C）的 CPU 波动比较。**
