---
lang: "zh-CN"
pubDatetime: 2026-09-14T11:18:35+08:00
...
![抽象的向量嵌入空间与邻域](./01-embedding-landscape.png)
...
![HNSW 在三层近邻图中逐层下降](./02-hnsw-descent.png)
...
![稀疏召回、稠密召回、候选池与重排的抽象链路](./03-retrieval-pipeline.png)
...
![Agent 围绕知识库、工作记忆和工具进行取证循环](./04-agent-evidence-loop.png)
