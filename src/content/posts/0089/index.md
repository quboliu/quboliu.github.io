...
**Linearizability: A Correctness Condition for Concurrent Objects｜线性一致性：并发对象的正确性条件**
...
**Fig. 1. FIFO queue histories.｜图。FIFO 队列历史。**
...
**Fig. 2. Register histories.｜图。寄存器历史。**
...
## 2. SYSTEM MODEL AND DEFINITION OF LINEARIZABILITY｜系统模型与线性一致性的定义
...
**Fig. 3. Axioms for queue operations.｜图。队列操作的公理。**
...
### 2.2 Definition of Linearizability｜线性一致性的定义
...
### 2.3 Queue Examples Revisited｜重访队列示例
...
## 3. PROPERTIES OF LINEARIZABILITY｜线性一致性的性质
...
### 3.2 Blocking versus Nonblocking｜阻塞与非阻塞
...
### 3.3 Comparison to Other Correctness Conditions｜与其他正确性条件的比较
...
## 4. VERIFYING THAT IMPLEMENTATIONS ARE LINEARIZABLE｜验证实现具有线性一致性
...
### 4.1 Definition of Correctness｜正确性的定义
...
### 4.2 Representation Invariant and Abstraction Function｜表示不变式与抽象函数
...
**Fig. 5. A queue history.｜图。一个队列历史。**
...
## 5. REASONING ABOUT LINEARIZABLE OBJECTS｜推理线性一致对象
...
### 5.1 Concurrent Registers｜并发寄存器
...
## I. GENERAL PROOFS OF CORRECTNESS｜附录：一般正确性证明

The proofs of the lemmas in this section are given elsewhere [45].

> 本节各引理的证明见另文 [45]。

### I.1 Possibilities and Linearized Values｜可能性与线性化值
...
### I.2 Four Generic Axioms｜四条通用公理
...
## II. PROOF OF CORRECTNESS FOR THE QUEUE｜附录：队列的正确性证明

### II.1 Two Lemmas About Concurrent Queues｜关于并发队列的两个引理
...
**Fig. 6. Annotated queue implementation.｜图。带断言标注的队列实现。**
