...
_Fig. 1. A comparison of cloud-hosting architecture and cloud-native architecture._

> _图 1。云托管架构与云原生架构的比较。_
...
_Fig. 2. An overview of cloud-native databases._
...
_Fig. 3. Architectures of cloud-native OLTP databases._

> _图 3。云原生 OLTP 数据库架构。_
...
_Fig. 4. An overview of cloud-native OLTP techniques._

> _图 4。云原生 OLTP 技术概览。_
...
_Fig. 5. The coupled data placement strategy._
...
_Fig. 6. The disaggregated data placement strategy._
...
_Fig. 7. Compute layer synchronization._
...
_Fig. 8. The comparison of monolithic architecture and disaggregation architecture on failure recovery._

> _图 8。单体架构与分离式架构在故障恢复上的比较。_
...
_Fig. 10. Architectures of cloud-native OLAP databases._

> _图 10。云原生 OLAP 数据库架构。_
...
_Fig. 12. An overview of cloud-native OLAP techniques._

> _图 12。云原生 OLAP 技术概览。_
...
_Fig. 11. Three key techniques based on metadata store._

> _图 11。基于元数据存储的三项关键技术。_
...
_Fig. 13. An example of data partition._
...
_Fig. 14. Three key techniques for query processing._
...
_Fig. 15. An overview of serverless computing._
...
_Fig. 16. Enclave-based query processing._

> _图 16。基于安全飞地（Enclave）的查询处理。_
