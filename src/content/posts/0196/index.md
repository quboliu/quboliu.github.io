---
lang: "zh-CN"
pubDatetime: 2026-09-19T18:00:42+08:00
...
tags:
  ...
  - "Bash"
  - "Linux"
description: "转载自 jlevy/the-art-of-command-line 的中文命令行实践指南，涵盖 Bash、文件与数据处理、系统调试及跨平台技巧。"
---
> **转载说明**
>
> **原作者：** [Jeffrey J. Levy](https://github.com/jlevy) 与[全部贡献者、译者](https://github.com/jlevy/the-art-of-command-line/blob/master/AUTHORS.md)
>
> **原文：** [《The Art of Command Line》简体中文版](https://github.com/jlevy/the-art-of-command-line/blob/master/README-zh.md)
>
> **许可：** 本文遵循原文的 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.zh-hans) 许可转载；除链接修正与本转载说明外，正文保持原样。
...
如果你在本文中发现了错误或者存在可以改善的地方，请向[原项目贡献你的一份力量](https://github.com/jlevy/the-art-of-command-line/blob/master/CONTRIBUTING.md)。
